...
lineFuelMix('#fuelMixTop10', 'Brazil', xWidth, yHeight);
lineFuelMix('#fuelMixTop10', 'Canada', xWidth, yHeight);
lineFuelMix('#fuelMixTop10', 'China', xWidth, yHeight);
lineFuelMix('#fuelMixTop10', 'Germany', xWidth, yHeight);
lineFuelMix('#fuelMixTop10', 'India', xWidth, yHeight);
lineFuelMix('#fuelMixTop10', 'Iran', xWidth, yHeight);
lineFuelMix('#fuelMixTop10', 'Japan', xWidth, yHeight);
lineFuelMix('#fuelMixTop10', 'Russia', xWidth, yHeight);
lineFuelMix('#fuelMixTop10', 'South Korea', xWidth, yHeight);
lineFuelMix('#fuelMixTop10', 'United States', xWidth, yHeight);

lineFuelMix('#fuelMixTop1120', 'Australia', xWidth, yHeight);
lineFuelMix('#fuelMixTop1120', 'France', xWidth, yHeight);
lineFuelMix('#fuelMixTop1120', 'Indonesia', xWidth, yHeight);
lineFuelMix('#fuelMixTop1120', 'Italy', xWidth, yHeight);
lineFuelMix('#fuelMixTop1120', 'Mexico', xWidth, yHeight);
lineFuelMix('#fuelMixTop1120', 'Saudi Arabia', xWidth, yHeight);
lineFuelMix('#fuelMixTop1120', 'Spain', xWidth, yHeight);
lineFuelMix('#fuelMixTop1120', 'Thailand', xWidth, yHeight);
lineFuelMix('#fuelMixTop1120', 'Turkey', xWidth, yHeight);
lineFuelMix('#fuelMixTop1120', 'United Kingdom', xWidth, yHeight);

function updateGraph() {
  
  d3.select('#fuelMixTop10').selectAll('*').remove();
  d3.select('#fuelMixTop1120').selectAll('*').remove();
